	...
	<?php echo $this->Session->flash(); ?>
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php echo $this->Html->link($orderDetail['Promote']['name'], array('controller' => 'promotes', 'action' => 'view', $orderDetail['Promote']['id'])); ?>
						...
						<td><?php echo h($orderDetail['OrderDetail']['code']); ?>&nbsp;</td>
						<td><?php echo h($orderDetail['OrderDetail']['data']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $orderDetail['OrderDetail']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $orderDetail['OrderDetail']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $orderDetail['OrderDetail']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $orderDetail['OrderDetail']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
