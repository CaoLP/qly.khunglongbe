...
<div class="panel-heading">
    <h3 class="panel-title">
		...
		<?php echo __('Product Options'); ?>	</h3>
</div>
	...
	<?php echo $this->Session->flash(); ?>
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php echo $this->Html->link($productOption['Product']['name'], array('controller' => 'products', 'action' => 'view', $productOption['Product']['id'])); ?>
						...
						<td><?php echo h($productOption['ProductOption']['code']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $productOption['ProductOption']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $productOption['ProductOption']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $productOption['ProductOption']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $productOption['ProductOption']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
